...
const (
	LoadBalancer_Redirect_FullMethodName = "/loadBalancer.loadBalancer/Redirect"
)
...
type LoadBalancerClient interface {
	Redirect(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *loadBalancerClient) Redirect(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, LoadBalancer_Redirect_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LoadBalancerServer interface {
	Redirect(context.Context, *Request) (*Response, error)
...
func (UnimplementedLoadBalancerServer) Redirect(context.Context, *Request) (*Response, error) {
...
func _LoadBalancer_Redirect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoadBalancerServer).Redirect(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LoadBalancer_Redirect_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoadBalancerServer).Redirect(ctx, req.(*Request))
	}
...
var LoadBalancer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Redirect",
			Handler:    _LoadBalancer_Redirect_Handler,
		},
	},
